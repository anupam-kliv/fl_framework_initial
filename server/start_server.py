...
parser.add_argument("--fraction", type = float,default = 1, #Default value for fraction is 1, which means all the clients are selected help = "Fraction of clients to select out of the number provided or those available. Float between 0 to 1 inclusive")
