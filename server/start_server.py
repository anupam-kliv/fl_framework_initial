...
parser.add_argument("--fraction", type = float, default = 1,  help = "Fraction of clients to select out of the number provided or those available. Float between 0 to 1 inclusive")
parser.add_argument("--rounds", type=int, default = 2, help = "Total number of communication rounds to perform")
parser.add_argument("--model_path",  default = "initial_model.pt", help = "The path of the initial server model's state dict")
